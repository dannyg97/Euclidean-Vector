...
EuclideanVector& EuclideanVector::operator*=(const int& multiplier) {
...
EuclideanVector operator*(const EuclideanVector& v1, const int& multipliedBy) {
  // Use a copy constructor here
  EuclideanVector result{v1};
  result *= multipliedBy;
  return result;
...
// Scalar multiplication operator
EuclideanVector operator*(const int& multipliedBy, const EuclideanVector& v1) {
  // Use a copy constructor here
  EuclideanVector result{v1};
  result *= multipliedBy;
  return result;
